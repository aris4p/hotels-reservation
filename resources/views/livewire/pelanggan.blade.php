                            ...
                            <table class="table table-striped table-sortable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort">No Hp</th>
                                        <th class="sort">Alamat</th>
                                        <th class="sort">Jenis Kelamin</th>
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->nama }}</td>
                                        <td>{{ $value->nik }}</span></td>
                                        <td>{{ $value->email }}</span></td>
                                        <td>{{ $value->nohp }}</span></td>
                                        <td>{{ $value->alamat }}</span></td>
                                        <td>{{ $value->jeniskelamin }}</span></td>
                                        <td>{{ $value->tgllahir }}</span></td>
                                        <td>
                                            <div class="dropdown">
